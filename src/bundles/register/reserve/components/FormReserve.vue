  ...
  <div v-loading="load_data" :element-loading-text="message_load">
    ...
    <div class="row">
      ...
      <div class="col-md-2 col-lg-2 div-120" style="padding-right: 0px" :class="{error: validation.hasError('form.immobile_code')}">
        ...
        <input type="text" class="form-control input-sm" v-model="form.immobile_code" @blur="getImmobileDataPerCode" @keyup.enter="getImmobileDataPerCode">
    ...
    <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
      <div class="col-md-2 col-lg-2" style="width: 160px" :class="{error: validation.hasError('form.client_cpf')}">
        <label>CPF</label>
        <the-mask class="form-control input-sm" :mask="['###.###.###-##']" v-model="form.client_cpf" placeholder="som. números" @blur.native="getClientData" @keypress.enter.native="getClientData"/>
    ...
    <div class="row">
      <div class="col-md-2 div-140">
        <span v-if="load_data_query">
            <img :src="images.loading" style="position: absolute; right: 60px; top: 20px;"/>
          </span>
        <label>
          CEP
        </label>
        <the-mask type="text" class="form-control input-sm" :mask="['#####-###']" v-model="form.cep" placeholder="som. números"
                  @blur.native="queryZipCode(form.cep)" @keypress.enter.native="(queryZipCode(form.cep), load_data_query = true)"
                  :disabled="load_data_query"/>
      </div>
    ...
    <div class="row">
      <div class="col-md-4 col-lg-3" :class="{error: validation.hasError('form.attendant_register_id')}">
        ...
        <users-system id="attendant_register"/>
      ...
      <div class="col-md-4 col-lg-3" :class="{error: validation.hasError('form.attendant_reception_id')}">
        ...
        <users-system id="attendant_reception" :setUser="form.attendant_reception_id"/>
...
export default {
  ...
  methods: {
    ...
    setForm (data) {
      ...
      $('#value_negotiated').focus()
    },
    getClientData () {

      if (this.form.client_cpf.length != 11) {
