      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding: 5px 10px 5px 10px" v-loading="load_data" :element-loading-text="message_load">
            ...
            <!-- component not found -->
            <div class="row" style="margin-top: 30px" v-if="!attendants_score_transfer.length">
            ...
            <div class="row" style="margin-top: 10px">
              <div class="col-md-12">
                <div class="table-responsive" v-if="attendants_score_transfer.length">
                  <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                    <tr v-for="list in attendants_score_transfer">
                      <td>
...
export default {
  ...
  methods: {
    ...mapActions('Register', ['getAttendantsScoreTransfer']),
    wordUpper,
    openModal() {
    ...
    save () {
      this.load_data = true
      http.post('register/transfer/score-attendant', this.form).then(res => {

        this.getAttendantsScoreTransfer()
        this.cleanForm()
    ...
    update () {
      this.load_data = true
      http.put(`register/transfer/score-attendant/${this.form.id}`, this.form).then(res => {
    ...
    remove (id) {
      this.load_data = true
      http.delete(`register/transfer/score-attendant/${id}`).then(res => {
  ...
  computed: {
    ...mapState('Register', ['attendants_score_transfer'])
  },
  watch: {
    dataModal() {
